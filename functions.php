...
add_image_size( 'project-gallery', 1000, false );
add_image_size( 'project-thumbnail-600', 600, 300, true);
/*
...
function core_scripts() {
	if ( !is_admin()) {
      ...
      //wp_register_script( 'stickyfloat', get_stylesheet_directory_uri() . '/library/js/stickyfloat.js', false, false, true );
      //wp_enqueue_script( 'stickyfloat' );

      wp_register_script('sticky-kit', get_stylesheet_directory_uri() . '/library/js/jquery.sticky-kit.min.js', false, false, true );
...
if( function_exists('acf_add_options_page') ) {
  acf_add_options_page('Homepage Slideshow');
}
